! function (e, t) {
    ...
    return function (e) {
        ...
        ***************************************************************************** */
        ...
        var r = n(4),
            ...
            u = function () {
                ...
                return Object.defineProperty(e.prototype, "Host", {
                    get: function () {
                        return o.Storage.Local.GetOrAdd("Host", "wss://eastus2.stt.speech.microsoft.com")
                    },
                    enumerable: !0,
                    configurable: !0
        ...
        var r = n(3),
            ...
            c = function () {
                function e(e) {
                    ...
                    window.navigator.getUserMedia || window.navigator.mediaDevices && window.navigator.mediaDevices.getUserMedia ? this.actualRecognizer = o.CreateRecognizer(c, n) : console.error("This browser does not support speech recognition")
                }
        ...
        var r = n(0),
            o = n(7),
            i = "cid=" + crisEndpointId + "&Ocp-Apim-Subscription-Key",
            s = function () {
                function e(e) {
                    var t = this;
